...
In the age of AI, you can use **AI prompt injection** to bypass AI security. For example, you can join https://gandalf.lakera.ai/gandalf to try to bypass its 8-level security for fun.
...
# ℼ Research Interest:
  - Probabilistic generative AI models: Gaussian Process, Flow Matching, Diffusion Models, Schordinger bridge
  ...
  - Topological Simplicial Complex, Spectral graph theory
